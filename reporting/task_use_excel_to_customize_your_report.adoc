...
** 例如、名为的自定义保存视图的文件名称为、如果在该日期和时间保存了该视图、则该视图 `Volumes-not online`的文件名为 `health-volumes-05-May-2020-19-18-00.xlsx`。
...
* 如果存在自定义 Excel 文件，则 * 报告 * > * 上传 Excel* 菜单项旁边会有一个复选标记。下载Excel文件时、将使用具有自定义设置的版本。image:../media/upload_excel.png["显示如何将Excel上传到报告的UI屏幕截图。"]
