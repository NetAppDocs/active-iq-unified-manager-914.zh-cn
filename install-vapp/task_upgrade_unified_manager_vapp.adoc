...
.步骤
. 按照中的步骤进行 link:task_download_unified_manager_iso_image_vapp.html["下载 Unified Manager ISO 映像"]操作。
. 此外，请按照中所述的步骤link:task_upgrade_unified_manager_virtual_appliance_vapp.html["升级 Unified Manager"]进行操作。
