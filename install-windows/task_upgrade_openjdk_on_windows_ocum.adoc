...
NOTE: 下载文件需要Oracle帐户。如果您没有Oracle帐户、请转到link:https://login.oracle.com/mysso/signon.jsp?request_id=007["Oracle帐户登录"]页面创建一个。
...
. 展开 `zip`文件。
. 将目录和文件从生成的目录(例如、复制 `jdk`到安装Java的位置) `jdk-11.0.18`。示例： `C:\Program Files\NetApp\JDK\`
